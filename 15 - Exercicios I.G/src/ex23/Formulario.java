	...
	public Formulario(){
		...
		botaoConfirmar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(m.verificaDados(n1, n2) == true){
					JOptionPane.showMessageDialog(null, m.calculaVerificaIMC(n1, n2));;
				}else{
