...
public class Formulario {
	...
	public void inicializaFormulario() {
		...
		operacoes.addItem("Subtração");
		operacoes.addItem("Multiplicação");
		operacoes.addItem("Divisão");
