	...
	public void inicializaFormulario() {
		...
		botaoConfirmar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "O resultado é: "+m.calculaVM(n1, n2)+"M/S");
